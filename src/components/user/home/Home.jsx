          ...
          <div className="carousel-caption">
            <div className="p-3" style={{ maxWidth: 900 }}>
              ...
              <p className="mb-5 fs-5">
                Explore breathtaking destinations, create unforgettable memories, and plan your perfect getaway with ease. From peaceful mountains to vibrant cities and relaxing beaches, we help you find the ideal place for every journey.
              </p>
